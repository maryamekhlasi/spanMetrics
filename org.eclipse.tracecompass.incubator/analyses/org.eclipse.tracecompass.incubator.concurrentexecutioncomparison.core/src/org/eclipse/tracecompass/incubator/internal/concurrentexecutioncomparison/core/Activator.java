...
package org.eclipse.tracecompass.incubator.internal.concurrentexecutioncomparison.core;
...
public class Activator extends TraceCompassActivator {
    ...
    /** The plug-in ID */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.incubator.cuncurrentexecutioncomparision.core"; //$NON-NLS-1$
