 ...
 */
@NonNullByDefault
public final class ConcurrentStateHistoryBackendFactory {

    private ConcurrentStateHistoryBackendFactory() {
    }
    ...
    public static IStateHistoryBackend createHistoryTreeBackendNewFile(String ssid,
        ...
        if (queueSize > 0) {
            return new ConcurrentThreadedHistoryTreeBackend(ssid, stateFile, providerVersion, startTime, queueSize);
        }
        return new ConcurrentHistoryTreeBackend(ssid, stateFile, providerVersion, startTime);
    }
    ...
    public static IStateHistoryBackend createHistoryTreeBackendExistingFile(String ssid, File stateFile,
        ...
        return new ConcurrentHistoryTreeBackend(ssid, stateFile, providerVersion);
    }
}
